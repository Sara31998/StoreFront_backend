...
// import the types database
//import users from user type files
import Client_Type from '../../types_of_database/user_store_types'
// import  production order types
import Ord_Pro_Type from '../../types_of_database/order_product_store'
// import production types
import Pro_Store from '../../types_of_database/product_store_types'
//import order types
import Ord_Store from '../../types_of_database/order_from_store'
//Import the modles of database
// import production order models
import Pro_Ord_Store_Mod from '../ord_pro_table_modles'
// import order models
import Ord_Store_Mod from '../order_table_modles'
// import the user models
import Client_Store_Mod from '../user_table_moddles'

//import {Client_Store_Mod} from '../user_table_moddles'
// import Product models
import Pro_Store_Mod from '../product_table_modlles'
// The vriables create
// the vriable of the production order store
const pro_ord_store_model = new Pro_Ord_Store_Mod()
// the vriable of the produc store
const pro_store_model = new Pro_Store_Mod()
// the vriable of the Client of  store
const client_store_model = new Client_Store_Mod()
// the vriable of the order store
const ord_store_model = new Ord_Store_Mod()
  ...
  describe('client  Model', () => {
    ...
    it('test the  create a client', async () => {
      try{
        ...
        const result = await client_store_model.createUser({
            user_name: 'ssmith',  // tha name of client 
            first_name: 'Sallie', // the first  anme of client 
            last_name: 'Test', // the last name of client 
            your_email: 'sara@gmail.com', // // the email 
