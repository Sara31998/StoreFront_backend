...
const requestserver = supertest(applicatin)
...
describe('product in store to  controllers: ', () => {
    ...
    it(' return a new client after to created', (done) => {
        const data = {
            name_producr: 'Test', // the name of product in store 
            price_product: 40.0, // the price of the production
        ...
        // the post request of the server
            ...
            .expect({
                id: 1,  // the id of the production
                name_producr: 'Test', // the name of product in store 
                price_product: '$40.00', // the price of the production
                category_product: 'category a',  // the category of production in store
            })
        done()
    })
...
// test of the get one of the product by id 
 ...
 // test of the update prodiuct in store 
    it('test of the update prodiuct in store endpoint', (done) => {
        ...
        const data = {
            name_producr: 'Test edited',  // the name of product in store 
        ...
        requestserver
            ...
            .expect({
                id: 1, // the id of the production 
                name_producr: 'Test edited', // the name of product in store 
                price_product: 50.0, // the price of the production
                category_product: 'category a', // the category of production in store
            })
        done()
    })
