import Prodcut_Store_Query from '../../interface_of_store_/product_of_store_quer';
// the sql vriable to the product create in database
const sql_pro_store: Prodcut_Store_Query = {
  ...
  UpDateOne_Product:
    'UPDATE productstore SET name_producr = ($1) ,descount_product= ($2) , brand_product= ($3), price_product= ($4) , category_product = ($5) WHERE id = ($6) RETURNING *',
