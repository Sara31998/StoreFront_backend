...
const salt_password = parseInt(config_dotenv_1.default.SALT_ROUNDS, 10);
// create the hashpassword to used in token
const Passwod_Hash = (password) => {
    // create the password with hash
    bcrypt_1.default.hashSync(password + config_dotenv_1.default.BCRPT_PASSWORD, salt_password);
};
...
class Client_Store {
    ...
    async createUser(client) {
        try {
            ...
            const sqlcreate = 'INSERT INTO usersestore (user_name, first_name, last_name,your_email, your_password) VALUES($1, $2, $3, $4, $5) RETURNING *';
...
exports.Client_Store = Client_Store;
// export of the modlles
exports.default = Client_Store;
